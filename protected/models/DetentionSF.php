 ...
 */
class DetentionSF extends CActiveRecord
{
    /**
	...
	{
        $required_arr = array('detention_type, youth_id, court_status, 
        	snapshot_date, facility, residence_county','required');


     
		return array(
            $required_arr,
            array('charge_filed, probation_time_arrest, number_of_prior_stays_on_probation, number_prior_deliquency_arrests, number_prior_deliquency_causes_filed, number_prior_technical_violations_filed, number_prior_deliquency_cases_adjudicated, number_prior_adjudications_ab_felony, number_warants_issued_fta, number_prior_secure_detentions, number_times_admitted_detention_alternative, number_failed_from_detention_alternative, prior_awol_runaway_history, awol_runaway_at_time_detention, prior_dcs_involvement, current_dcs_involvement', 'numerical', 'integerOnly'=>true),
	...
	public function onBeforeValidate($event){
		...
		if($this->getAttribute('submited')){
            $required_arr = 'dsm_diagnosis, detention_type, snapshot_date, facility, youth_id, race, 
            	gender, ethnicity, incident, residence_county, admission_date, process_admitted_to_detention,
            	 referring_agency, release_to, specify_where, type_delinquent_act, preliminary_inquiry_date, adjudication_status,
            	  disposition_date, arrest_violation_date, adjudication_date, final_court_ordered_disposition, court_status,
            	  number_prior_deliquency_arrests, number_prior_deliquency_causes_filed, number_prior_technical_violations_filed,
            	  number_prior_deliquency_cases_adjudicated, number_prior_adjudications_ab_felony, number_of_prior_stays_on_probation, 
            	  most_severe_prior_adjudication, number_warants_issued_fta, number_open_petitions_pending_on_day, number_prior_secure_detentions, 
