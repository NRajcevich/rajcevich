 ...
 */
class Detention extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			//array('snapshot_date, facility, youth_id, race, gender, ethnicity, incident, residence_county, admission_date, process_admitted_to_detention, referring_agency, release_to, specify_where, type_delinquent_act, preliminary_inquiry_date, adjudication_status, disposition_date, arrest_violation_date, adjudication_date, final_court_ordered_disposition, court_status, number_prior_deliquency_arrests, number_prior_deliquency_causes_filed, number_prior_technical_violations_filed, number_prior_deliquency_cases_adjudicated, number_prior_adjudications_ab_felony, most_severe_prior_adjudication, number_warants_issued_fta, number_open_petitions_pending_on_day, number_prior_secure_detentions, number_times_admitted_detention_alternative, number_failed_from_detention_alternative, serious_awol_runaway_event, caregiver_availability, cbbt, psychotropic_medics_history, treatment_service_history, program, program_status, referral_admission_type, date_referred, date_ordered, remanding_judge, youth_location_leading_to_admission, program_admit_date, program_status_date', 'required'),
			array('charge_filed, 
				...
				number_prior_deliquency_cases_adjudicated, number_prior_adjudications_ab_felony,
				number_warants_issued_fta, number_prior_secure_detentions, number_times_admitted_detention_alternative,
				number_failed_from_detention_alternative, prior_awol_runaway_history, awol_runaway_at_time_detention, 
				prior_dcs_involvement, current_dcs_involvement', 'numerical', 'integerOnly'=>true),
			//array('facility, youth_id, probation_number, race, ethnicity, incident, residence, residence_county, process_admitted_to_detention, referring_agency, release_to, specify_where, type_delinquent_act, severe_arrest_offense, severe_arrest_offense_sel, adjudication_status, final_court_ordered_disposition, court_status, most_severe_prior_adjudication, number_open_petitions_pending_on_day, serious_awol_runaway_event, caregiver_availability, cbbt, psychotropic_medics_history, treatment_service_history, program, program_status, referral_admission_type, remanding_judge, youth_location_leading_to_admission', 'length', 'max'=>45),
            ...
            array('dsm_diagnosis, offense_type, prior_adjudication_type, created_date, updated_date, updated_user, submited, detention_type,
             snapshot_date, facility, youth_id, race, gender, ethnicity, incident, residence, residence_county, admission_date, 
             process_admitted_to_detention, referring_agency, release_to, specify_where, type_delinquent_act, preliminary_inquiry_date, 
             adjudication_status, disposition_date, arrest_violation_date, adjudication_date, final_court_ordered_disposition, court_status, 
             number_prior_deliquency_arrests, number_prior_deliquency_causes_filed, number_prior_technical_violations_filed, 
             number_prior_deliquency_cases_adjudicated, number_prior_adjudications_ab_felony, most_severe_prior_adjudication, 
             number_warants_issued_fta, number_open_petitions_pending_on_day, number_prior_secure_detentions, 
             number_times_admitted_detention_alternative, number_failed_from_detention_alternative, serious_awol_runaway_event, 
             caregiver_availability, cbbt, psychotropic_medics_history, treatment_service_history, program, program_status, 
             ...
             program_status_date,refferal_evaluation_ad,refferal_evaluation_ad_date_ordered,refferal_evaluation_ad_date_completed,
             refferal_psychological,refferal_psychological_date_ordered,refferal_psychological_date_completed,refferal_psychiatric,
             refferal_psychiatric_date_ordered,refferal_psychiatric_date_completed,refferal_other,refferal_other_label,refferal_other_date_ordered,
             ...
             dispositional_rtf_date_completed,dispositional_ad_residental,dispositional_ad_residental_date_ordered,
             dispositional_ad_residental_date_completed,dispositional_shelter_care,dispositional_shelter_care_date_ordered,
             dispositional_shelter_care_date_completed,dispositional_drug_court,dispositional_drug_court_date_ordered,
             dispositional_drug_court_date_completed,dispositional_intensive_probation_supervision,
             dispositional_intensive_probation_supervision_date_ordered,dispositional_intensive_probation_supervision_date_completed,
             dispositional_probation,dispositional_probation_date_ordered,dispositional_probation_date_completed,dispositional_other,
             dispositional_other_label,dispositional_other_date_ordered,dispositional_other_date_completed', 'safe'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'time_referred' => 'Time Referred',
			'process_admitted_to_detention' => 'Process by Which Admitted to Detention Facility',
			...
			'caregiver_availability' => 'Parent/Caregiver Availability',
	...
	public function search()
	{
        ...
        if($this_user->attributes['county'] == 'ALL'){
            $this_residence_county = $this->residence_county;
        }else{
            $this_residence_county = $this_user->attributes['county'];
        }
		...
		$criteria->compare('residence_county',$this_residence_county,true);
		$criteria->compare('admission_date',$this->admission_date,true);
		$criteria->compare('time_referred',$this->time_referred,true);
		$criteria->compare('process_admitted_to_detention',$this->process_admitted_to_detention,true);
		$criteria->compare('referring_agency',$this->referring_agency,true);
        ...
        $criteria->compare('submited',$this->submited,true);
